...
function init_gear_sets()
	...
	sets.midcast.Cure =
	{
		...
		back = "Alaunus's Cape", waist = "Hachirin-no-Obi", legs = "Ebers Pant. +2", feet = "Kaykaus Boots +1"
	}
	...
	sets.midcast.Banish = set_combine(sets.midcast['Divine Magic'], { head = "Ipoca Beret" })

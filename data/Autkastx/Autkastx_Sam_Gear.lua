...
function init_gear_sets()
	...
	sets.precast.WS['Tachi: Rana'] = set_combine(sets.precast.WS,
	{
		ammo = "Coiste Bodhar",
		ear1 = "Schere Earring",
		body = "Sakonji Domaru +3", ring2 = "Regal Ring",
		feet = "Mpaca's Boots"
	})
	...
	{
		body = "Mpaca's Doublet", ring2 = "Begrudging Ring",
	})
	sets.precast.WS['Impulse Drive'].PDL = set_combine(sets.precast.WS['Impulse Drive'], sets.precast.WS.PDL,
	{
		body = "Nyame Mail",
		legs = "Mpaca's Hose",
	})
	...
	sets.precast.WS['Stardiver'].PDL = set_combine(sets.precast.WS['Stardiver'], sets.precast.WS.PDL,
	{
		ammo = "Crepuscular Pebble",
	})
	...
	sets.weapons.Trial = { main = "Windslicer", sub = "Utu Grip" }

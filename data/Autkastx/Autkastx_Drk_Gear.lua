...
function init_gear_sets()
	...
	sets.precast.FC = {ammo="Impatiens",
		...
		back="Moonlight Cape",waist="Carrier's Sash",legs=gear.odyssean_fc_legs,feet="Odyssean Greaves"}
	...
	sets.midcast['Dark Magic'] = {ammo="Pemphredo Tathlum",
		...
		back="Toro Cape",waist="Skrymir Cord +1",legs="Eschite Cuisses",feet="Flam. Gambieras +2"}
           
	sets.midcast['Enfeebling Magic'] = {ammo="Pemphredo Tathlum",
		head="Carmine Mask +1",neck="Erra Pendant",ear1="Digni. Earring",ear2="Malignance Earring",
		body="Flamma Korazin +2",hands="Flam. Manopolas +2",ring1="Stikini Ring +1",ring2="Stikini Ring +1",
		back="Toro Cape",waist="Skrymir Cord +1",legs="Flamma Dirs +2",feet="Flam. Gambieras +2"}
    ...
    sets.idle = {ammo="Staunch Tathlum +1",
		...
		back="Shadow Mantle",waist="Carrier's Sash",legs="Carmine Cuisses +1",feet="Amm Greaves"}

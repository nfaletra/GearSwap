...
function init_gear_sets()
	...
	sets.precast.FC =
	{
		...
		body = "Zendik Robe", hands = "Acad. Bracers +3", ring1 = "Kishar Ring", ring2 = "Rahab Ring",
	...
	sets.precast.WS =
	{
		...
		head = "Nyame Mail", neck = "Fotia Gorget", ear1 = "Crep. Earring", ear2 = "Telos Earring",
	...
	{
		ear1 = "Regal Earring", ear2 = "Moonshade Earring",
		ring1 = "Metamor. Ring +1", ring2 = "Rufescent Ring",
	})
	...
	sets.MagicBurst =
	{
		head = "Pedagogy Mortarboard +1", neck = "Mizu. Kubikazari",
		ring1 = "Mujin Band",
		legs = "Agwu's Slops"
	}
	...
	sets.midcast.Cure =
	{
		...
		body = "Kaykaus Bliaut", hands = "Pedagogy Bracers +1", ring1 = "Menelaus's Ring", ring2 = "Lebeche Ring",
	...
	sets.midcast.Aquaveil = set_combine(sets.midcast['Enhancing Magic'].Duration,
	{
		main = "Vadose Rod",
		head = "Amalric Coif +1",
		body = "Rosette Jaseran +1", hands = "Regal Cuffs", ring1 = "Evanescence Ring", ring2 = "Freke Ring",
	...
	sets.midcast['Enfeebling Magic'] =
	{
		...
		head = "Acad. Mortar. +3", neck = "Erra Pendant", ear1 = "Malignance Earring", ear2 = "Regal Earring",
		body = "Academic's Gown +1", hands = "Regal Cuffs", ring1 = "Kishar Ring", ring2 = "Metamor. Ring +1",
		back = "Aurist's Cape +1", waist = "Obstin. Sash", legs = "Academic's Pants +1", feet = "Academic's Loafers +1"
	}
	...
	{
		main = "Bunzi's Rod", sub = "Ammurapi Shield", ammo = "Pemphredo Tathlum",
		head = "", neck = "Saevus Pendant +1", ear1 = "Malignance Earring", ear2 = "Regal Earring",
		body = "Cohort Cloak +1", hands = "Agwu's Gages", ring1 = "Freke Ring", ring2 = "Metamor. Ring +1",
		back = "Fi Follet Cape +1", waist = "Acuity Belt +1", legs = "Merlinic Shalwar", feet = "Agwu's Pigaches"
	}
	...
	sets.idle =
	{
		...
		head = "Volte Beret", neck = "Twilight Torque", ear1 = "Lugalbanda Earring", ear2 = "Etiolation Earring",
		body = "Agwu's Robe", hands = "Agwu's Gages", ring1 = "Mephitas's Ring +1", ring2 = "Defending Ring",
		back = "Moonlight Cape", waist = "Carrier's Sash", legs = "Assid. Pants +1", feet = "Volte Gaiters"
	}
	...
	sets.idle.PDT =
	{
		...
		body = "Agwu's Robe", hands = "Nyame Gauntlets", ring1 = "Mephitas's Ring +1", ring2 = "Defending Ring",
	...
	{
		main = "Daybreak", sub = "Genmei Shield", ammo = "Staunch Tathlum +1",
		head = "Agwu's Cap", neck = "Twilight Torque", ear1 = "Lugalbanda Earring", ear2 = "Etiolation Earring",
		body = "Agwu's Robe", hands = "Agwu's Gages", ring1 = "Mephitas's Ring +1", ring2 = "Defending Ring",
		back = "Moonlight Cape", waist = "Carrier's Sash", legs = "Agwu's Slops", feet = "Agwu's Pigaches"
	}
	...
	{
		ammo = "Amar Cluster",
		head = "Blistering Sallet +1", neck = "Combatant's Torque", ear1 = "Crep. Earring", ear2 = "Baldur Earring +1",

...
function init_gear_sets()
	...
	sets.midcast['Elemental Magic'] =
	{
		...
		back = gear.Taranus.Idle, waist = "Acuity Belt +1", legs = "Wicce Chausses +3", feet = "Wicce Sabots +2"
	}
    ...
    sets.midcast['Elemental Magic'].OccultAcumen = {main="Khatvanga",sub="Bloodrain Strap",ammo="Seraphic Ampulla",
        ...
        back=gear.Taranus.Idle,waist="Oneiros Rope",legs="Perdition Slops",feet=gear.merlinic_occult_feet}
	...
	sets.MagicBurst =
	{
		...
		back = gear.Taranus.Idle, waist = "Acuity Belt +1", legs = "Wicce Chausses +3", feet = "Agwu's Pigaches"
	}

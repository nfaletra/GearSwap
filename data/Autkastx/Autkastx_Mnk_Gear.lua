...
function init_gear_sets()
	...
	sets.precast.WS['Ascetic\'s Fury'] =
	{
		...
		body = "Nyame Mail", hands = "Bhikku Gloves +3", ring1 = "Niqmaddu Ring", ring2 = "Gere Ring",
		back = gear.Segomo.STR_DA, waist = "Fotia Belt", legs = "Mpaca's Hose", feet = "Nyame Sollerets",
	}
	...
	sets.precast.WS['Final Heaven'] =
	{
		...
		body = "Bhikku Cyclas +3", hands = "Nyame Gauntlets", ring1 = "Niqmaddu Ring", ring2 = "Gere Ring",
		back = gear.Segomo.VIT_WSD, waist = "Moonbow Belt +1", legs = "Nyame Flanchard", feet = "Nyame Sollerets"
	}
	...
	{
		ammo = "Crepuscular Pebble",
		head = "Ken. Jinpachi +1", neck = "Mnk. Nodowa +2", ear2 = "Mache Earring +1",
		body = "Malignance Tabard", hands = "Bhikku Gloves +3",
	...
	{
		ammo = "Coiste Bodhar",
		head = "Mpaca's Cap", neck = "Rep. Plat. Medal", ear1 = "Moonshade Earring", ear2 = "Schere Earring",
		body = "Nyame Mail", hands = "Bhikku Gloves +3", ring1 = "Niqmaddu Ring", ring2 = "Gere Ring",
		back = gear.Segomo.STR_DA, waist = "Moonbow Belt +1", legs = "Mpaca's Hose", feet = "Nyame Sollerets"
	}
	...
	sets.precast.WS['Asuran Fists'] =
	{
		ammo = "Coiste Bodhar",
		head = "Hes. Crown +3", neck = "Fotia Gorget", ear1 = "Sherida Earring", ear2 = "Schere Earring",
		body = "Bhikku Cyclas +3", hands = "Bhikku Gloves +3", ring1 = "Regal Ring", ring2 = "Sroda Ring",
	...
	sets.precast.WS['Asuran Fists'].PDL = set_combine(sets.precast.WS['Asuran Fists'],
	{
		ammo = "Crepuscular Pebble",
		neck = "Mnk. Nodowa +2",
		body = "Malignance Tabard", ring1 = "Niqmaddu Ring",
		legs = "Mpaca's Hose",
	})
	...
	sets.precast.WS['Dragon Blow'] =
	{
		...
		body = "Bhikku Cyclas +3", hands = "Bhikku Gloves +3", ring1 = "Niqmaddu Ring", ring2 = "Epaminondas's Ring",
		back = gear.Segomo.VIT_WSD, waist = "Moonbow Belt +1", legs = "Mpaca's Hose", feet = "Nyame Sollerets"
	}
	...
	{
		ammo = "Coiste Bodhar",
		head = "Malignance Chapeau", neck = "Mnk. Nodowa +2", ear1 = "Sherida Earring", ear2 = "Schere Earring",
	...
	sets.engaged.Staff.DT = set_combine(sets.engaged.DT, { neck = "Anu Torque", legs = "Mpaca's Hose" })

	sets.engaged.Counter =
	{
		ammo = "Coiste Bodhar",
		head = "Bhikku Crown +3", neck = "Bathy Choker +1", ear1 = "Sherida Earring", ear2 = "Bhikku Earring +1",
		body = "Mpaca's Doublet", hands = "Malignance Gloves", ring1 = "Niqmaddu Ring", ring2 = "Defending Ring",
		back = gear.Segomo.Counter, waist = "Moonbow Belt +1", legs = "Bhikku Hose +3", feet = "Malignance Boots"
	}
	...
	{
		ammo = "Staunch Tathlum +1",
		head = "Bhikku Crown +3", neck = "Loricate Torque +1", ear1 = "Sherida Earring", ear2 = "Telos Earring",
		body = "Mpaca's Doublet", hands = "Malignance Gloves", ring1 = "Niqmaddu Ring", ring2 = "Defending Ring",

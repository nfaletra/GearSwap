...
sets.crafting.Fishing = {range = "Halcyon Rod", ammo = "Sabiki Rig" }
...
sets.crafting.Alchemy = { main = "Caduceus", body = "Alchemist's Smock", neck = "Alchemst. Torque", ring1 = "Orvail Ring" } -- {main="Caduceus",sub="Brewer's Escutcheon"}

...
function init_gear_sets()
	...
	{
		ammo = "Sapience Orb",
		head = "Carmine Mask +1", neck = "Voltsurge Torque", ear1 = "Loquac. Earring", ear2 = "Enchanter's Earring +1",
	...
	sets.idle.Duban =
	{
		...
		back = gear.Rudianos.Enmity, waist = "Flume Belt +1", legs = "Chev. Cuisses +3", feet = "Rev. Leggings +3"
	}

...
user_settings = {
    user_spells = {
        ...
        Enhancing = T{'Barstone', 'Baraero', 'Barfire'},
        Ninjutsu = T{},
        Singing = T{"Knight's Minne", "Knight's Minne II", "Knight's Minne III"},
        Blue = T{},
        Summoning = T{'Carbuncle','Cait Sith','Ifrit','Shiva','Garuda','Titan','Ramuh','Leviathan','Fenrir','Diabolos','Siren'}},
    save_settings = false} --change this to true if you wish to save the last position of your skillup window
sets.brd = {
    wind_inst = {
        range="Mary's Horn"},--put your wind instrument here
    string_inst = {

...
function user_job_setup()
	...
	gear.Alaunus =
	{
		Idle = { name = "Alaunus's Cape", augments = { 'MND+20', 'Eva.+20 /Mag. Eva.+20', 'Mag. Evasion+10', 'Enmity-10', 'Damage taken-5%' } },
		FC = { name = "Alaunus's Cape", augments = { 'MND+20', 'Eva.+20 /Mag. Eva.+20', '"Fast Cast"+10' } }
	}
...
function init_gear_sets()
	...
	sets.precast.WS =
	{
		...
		back = gear.Alaunus.Idle, waist = "Luminary Sash", legs = "Nyame Flanchard", feet = "Nyame Sollerets"
	}
	...
	sets.precast.WS['Hexa Strike'] = set_combine(sets.precast.WS,
	{
		...
		back = gear.Alaunus.Idle, waist = "Fotia Belt", legs = "Piety Pantaln. +3", feet = "Piety Duckbills +3"
	})
	...
	sets.idle.DT =
	{
		...
		back = gear.Alaunus.Idle, waist = "Carrier's Sash", legs = "Inyanga Shalwar +2", feet = "Nyame Sollerets"
	}

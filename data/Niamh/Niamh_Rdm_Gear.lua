function user_job_setup()
	...
	state.Weapons:options('None', 'Naegling', 'Croc', 'Excalibur', 'Maxentius', 'DualSavage', 'DualSavageAcc', 'DualSeraph', 'DualSanguine', 'DualExcalibur', 'DualClubs', 'DualClubsAcc', 'DualTauret', 'DualAeolian', 'EnspellOnly', 'DualProc')
...
function init_gear_sets()
	...
	sets.precast.WS =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Fotia Belt", legs = "Nyame Flanchard", feet = "Leth. Houseaux +3"
	}
	...
	sets.precast.WS['Knights of Round'] =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Sailfi Belt +1", legs = "Nyame Flanchard", feet = "Leth. Houseaux +3"
	}
	...
	sets.precast.WS['Chant du Cygne'] =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Fotia Belt", legs = "Zoar Subligar +1", feet = "Thereoid Greaves"
	}
	...
	sets.precast.WS['Sanguine Blade'] =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Orpheus's Sash", legs = "Leth. Fuseau +3", feet = "Leth. Houseaux +3"
	}
	...
	sets.precast.WS['Red Lotus Blade'] =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Orpheus's Sash", legs = "Nyame Mail", feet = "Leth. Houseaux +3"
	}
	...
	sets.precast.WS['Seraph Blade'] =
	{
		...
		back = gear.Sucellos.WSD_STR, waist = "Orpheus's Sash", legs = "Nyame Flanchard", feet = "Leth. Houseaux +3"
	}
	...
	sets.midcast['Elemental Magic'] =
	{
		...
		back = "Aurist's Cape +1", waist = "Acuity Belt +1", legs = "Leth. Fuseau +3", feet = gear.amalric.feet.a
	}
	...
	sets.weapons.DualSavageAcc = { main = "Naegling", sub = "Ternion Dagger +1" }
	...
	sets.weapons.DualClubsAcc = { main = "Maxentius", sub = "Ternion Dagger +1" }
	sets.weapons.DualTauret = { main = "Tauret", sub = "Gleti's Knife" }
	sets.weapons.DualAeolian = { main = "Tauret", sub = "Daybreak" }
	sets.weapons.EnspellOnly = { main = "Crocea Mors", sub = "Ceremonial Dagger", range = "Ullr", ammo = "Beetle Arrow" }
